#!/usr/bin/env python3
"""Parser for beds catalog on hoff.ru (Playwright + stealth, bypasses QRATOR)"""
...
CATALOG_URL = "https://hoff.ru/catalog/spalnya/krovati/"
OUTPUT_FILE = Path(__file__).parent / "hoff_beds.json"
...
def main():
    parser = argparse.ArgumentParser(description="Parse beds from hoff.ru")
    parser.add_argument("--max-pages", type=int, default=100)
    parser.add_argument("--output", type=str, default=str(OUTPUT_FILE))
    args = parser.parse_args()

    log.info("Starting hoff.ru beds parser")
